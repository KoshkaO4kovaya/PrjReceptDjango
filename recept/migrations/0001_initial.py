    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('g', 'Граммы'), ('ml', 'Миллилитры'), ('pcs', 'Штуки')], default='pcs', help_text='Единица измерения', max_length=5)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_ingredients', models.ManyToManyField(related_name='recipes', to='recept.mainingredient')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='recept.mainingredient')),
